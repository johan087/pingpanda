...
const getBadgetStyles = (color: BadgeColor) => {
  switch (color) {
    case "#43b581":
      return "bg-green-500/10 text-green ring-green-500/20";
    case "#faa61a":
      return "bg-yellow-500/10 text-yellow ring-yellow-500/20";
    default:
      return "bg-gray-500/10 text-gray ring-gray-500/20";
  }
};
    ...
    <div className="w-full flex items-start justify-start">
      ...
      <div className="w-full max-w-xl">
        <div className="flex items-center">
          ...
          <span className="ml-2 px-1.5 py-0.5 text-xs font-semibold bg-blue-400 text-white rounded">
            APP
          </span>
            ...
            {badgeText ? (
              <span
                className={cn(
                  ...
                  getBadgetStyles(badgeColor)
                )}
              >
                {badgeText}
              </span>
            ) : null}
            <p className="text-white order-1 text-bae/7 font-semibold">
              {title}{" "}
            </p>
          </div>
