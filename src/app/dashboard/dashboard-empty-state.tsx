...
export const DashbooardEmptyState = () => {
  ...
  return (
    <Card className="flex flex-col items-center justify-center rounded-2xl flex-1 text-center p-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 s:space-y-0 sm:space-x-4">
        <Button
          variant="outline"
        ...
        <CreateEventCategoryModal containerClassName="w-full sm:w-auto">
          <Button className="flex items-cnetr space-x-2 w-full s:w-auto">
